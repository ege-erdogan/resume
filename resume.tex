...
\personalinfo{%
  ...
  \github{ege-erdogan} 
  \\~\\
  \printinfo{}{\textit{Last updated June 12, 2020. For the latest version, see: https://erdogan.dev/resume}}
}
...
\cvsection{Education}
\cvevent{Koc University}{Computer Engineering (\textit{GPA = 3.46 / 4.0})}{ 2017 -- }{}
